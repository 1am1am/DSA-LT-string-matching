...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{data/Graph/Running Time - Scenario 1.pdf}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{data/Graph/Comparisons - Scenario 1.pdf}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{data/Graph/Running Time - Scenario 2.pdf}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{data/Graph/Comparisons - Scenario 2.pdf}
\end{figure}
...
\subsection{Tables of Experimental Data}
...
\newpage
\subsection{Performance Evaluation and Comments}
...
\includepdf[pages={1}, landscape=true, scale=0.9, pagecommand={}]{data/Running Time - Scenario 1.pdf}
\includepdf[pages={1}, landscape=true, scale=0.9, pagecommand={}]{data/Comparison - Scenario 1.pdf}
\includepdf[pages={1}, landscape=true, scale=0.9, pagecommand={}]{data/Running Time - Scenario 2.pdf}
\includepdf[pages={1}, landscape=true, scale=0.9, pagecommand={}]{data/Comparison - Scenario 2.pdf}
...
\label{sec:problem-statement}
    \lettrine[lines=2]{\scalebox{1.4}{\textbf{S}}}{TRING} matching is a problem that 
    ...
    such as text editing, text searching, and symbol manipulation.
    ...
    $0 \le s \le n-m$ ($s$ is the shift amount) and $T[s+1..s+m] = P[1..m]$ (that is, if $T[s+i]=P[i]$, for $1 \le i \le m$).
